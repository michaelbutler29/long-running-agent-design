...
`cdk-outputs.json` lands in this directory and is consumed by [main.py](../main.py), [policy_evaluator_agent/judge.py](../policy_evaluator_agent/judge.py), and [seed_policy.py](../seed_policy.py). It is gitignored.
